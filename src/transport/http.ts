...
async function createNewSession(
    ...
    const transport = new StreamableHTTPServerTransport({
        ...
        onsessioninitialized: (sessionId) => {
            ...
            console.log('New DailyImprovement session created:', sessionId);
        }
    });
    ...
    transport.onclose = () => {
        if (transport.sessionId) {
            ...
            console.log('DailyImprovement session closed:', transport.sessionId);
        }
    };
...
function logServerStart(config: Config): void {
    ...
    console.log(`DailyImprovement MCP Server listening on ${displayUrl}`);
